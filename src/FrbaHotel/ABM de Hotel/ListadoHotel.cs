...
namespace FrbaHotel.ABM_de_Hotel
{
    public partial class ListadoHotel : Form
    {
        ...
        {
            string queryFinal = "SELECT Hotel_Id,Hotel_Nombre,Hotel_Mail,Hotel_Telefono,Hotel_Calle,Hotel_Nro_Calle,Hotel_Ciudad,Hotel_Pais,Hotel_Cant_Est,Hotel_Fecha_Creacion FROM NENE_MALLOC.Hotel";
