...
namespace FrbaHotel.ABM_de_Usuario
{
    public partial class PantallaListado : Form
    {
        ...
        {
            string queryFinal = "SELECT U.Usuario_Id,U.Usuario_datos,U.Usuario_name,U.Usuario_pass,DP.Datos_Nombre,DP.Datos_Apellido,DP.Datos_Tipo_Ident,DP.Datos_Nro_Ident,DP.Datos_Mail,DP.Datos_Telefono,DP.Datos_Dom_Calle,DP.Datos_Dom_Nro_Calle,DP.Datos_Dom_Piso,DP.Datos_Dom_Depto,UP.Hotel_Id,DP.Datos_Fecha_Nac  "
